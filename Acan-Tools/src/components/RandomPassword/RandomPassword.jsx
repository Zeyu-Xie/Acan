...
class RandomPassword extends React.Component {
    ...
    constructor(props) {
        super(props)
        this.getRandomPassword = this.getRandomPassword.bind(this)
    }
    ...
    render() {
        return (
            <div className="card flip-in-hor-bottom col-sm-9 col-md-6 col-lg-5 col-xl-4 col-11" id="card-randomPassword">
