                    ...
                    <div className="container">
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            ...
                            <ul className="navbar-nav" style={{ marginLeft: "auto" }}>
                                ...
                                <li className="nav-item">
                                    <a href="https://github.com/Zeyu-Xie" className="nav-link">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="fab fa-github" viewBox="0 0 16 16">
                                ...
                                <li className="nav-item">
                                    <a href="#" className="nav-link">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="fab fa-twitter" viewBox="0 0 16 16">
                                ...
                                <li className="nav-item">
                                    <a href="#" className="nav-link">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="fab fa-instagram" viewBox="0 0 16 16">
